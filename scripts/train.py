...
def parse_arguments():
    ...
    parser.add_argument("--folder", type=str, default="/pscratch/sd/v/vmikuni/parnassus/", help="Folder containing input files")
...
def main():
    ...
    train_loader = utils.DataLoader(os.path.join(flags.folder,'train.h5'), flags.batch, hvd.rank(), hvd.size())
    val_loader = utils.DataLoader(os.path.join(flags.folder,'val_ggF.h5'), flags.batch, hvd.rank(), hvd.size())
